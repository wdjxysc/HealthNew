...
NSString *dataPointTapNotification = @"dataPointTapNotification";
...
- (id)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        self.xAxisLabel.textColor = UIColorFromRGB(0x999999);
...
- (void)showIndicatorForTouch:(UITouch *)touch {
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:dataPointTapNotification object:closest.xLabel userInfo:nil];
