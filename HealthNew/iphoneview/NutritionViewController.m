...
//        [self.navigationController.navigationItem setTitle:NSLocalizedString(@"NUTRITION", nil)];
        self.navigationItem.title = NSLocalizedString(@"NUTRITION", nil);
...
-(void)initMyView
{
    _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 64, 320, 42)];
    _searchBar.placeholder = @"Please enter food name";
    [self.view addSubview:_searchBar];
    _searchBar.delegate = self;
    
    _tabelView = [[UITableView alloc]initWithFrame:CGRectMake(0, 106, 320, Screen_height-155)];
